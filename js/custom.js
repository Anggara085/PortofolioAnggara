(function () {
  ...
  var portfolioMasonry = function () {
    // Klik filter untuk mengubah filter aktif
    $(".filters ul li").click(function () {
      $(".filters ul li").removeClass("active"); // Menghapus kelas active dari semua item
      $(this).addClass("active"); // Menambahkan kelas active pada item yang diklik

      var data = $(this).attr("data-filter");
      $grid.isotope({
        filter: data, // Menggunakan data-filter untuk menyaring elemen
      });
    });

    // Pastikan filter default diterapkan saat halaman dimuat ulang
    if (document.getElementById("section-portfolio")) {
      var $grid = $(".grid").isotope({
        ...
        filter: ".typography", // Filter default saat halaman dimuat ulang
      });
    }
  };
